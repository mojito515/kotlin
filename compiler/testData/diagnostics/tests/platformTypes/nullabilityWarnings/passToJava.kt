...
fun test(n: J?, nn: J) {
    ...
    J.staticNN = <!TYPE_MISMATCH!><!NI;TYPE_MISMATCH!>n<!><!>
    J.staticNN = <!TYPE_MISMATCH!><!NI;TYPE_MISMATCH!>platformN<!><!>
    J.staticNN = nn
    ...
    J().nn = <!TYPE_MISMATCH!><!NI;TYPE_MISMATCH!>n<!><!>
    J().nn = <!TYPE_MISMATCH!><!NI;TYPE_MISMATCH!>platformN<!><!>
    J().nn = nn
    J().nn = platformNN
    J().nn = platformJ
