...
fun test1(int: Int, any: Any) {
    ...
    val a1 : MyList<Int> = <!OI;TYPE_INFERENCE_EXPECTED_TYPE_MISMATCH!><!NI;TYPE_MISMATCH!>getMyList(any)<!><!>
    ...
    val a9 : MyList<in Any> = <!OI;TYPE_INFERENCE_EXPECTED_TYPE_MISMATCH!><!NI;TYPE_MISMATCH!><!NI;TYPE_MISMATCH!>getMyListToReadFrom(int)<!><!><!>

    val a10 : MyList<out Int> = <!TYPE_MISMATCH!><!NI;TYPE_MISMATCH!>getMyList<Any>(any)<!><!>
    val a11 : MyList<out Int> = <!OI;TYPE_INFERENCE_EXPECTED_TYPE_MISMATCH!><!NI;TYPE_MISMATCH!><!NI;TYPE_MISMATCH!>getMyList(any)<!><!><!>

    val a12 : MyList<out Int> = <!TYPE_MISMATCH!><!NI;TYPE_MISMATCH!>getMyListToWriteTo<Any>(any)<!><!>
    val a13 : MyList<out Int> = <!OI;TYPE_INFERENCE_EXPECTED_TYPE_MISMATCH!><!NI;TYPE_MISMATCH!><!NI;TYPE_MISMATCH!>getMyListToWriteTo(any)<!><!><!>
    ...
    readFromMyList<Int>(<!OI;TYPE_INFERENCE_EXPECTED_TYPE_MISMATCH!><!NI;TYPE_MISMATCH!><!NI;TYPE_MISMATCH!>getMyList(any)<!><!><!>, int)

    readFromMyList<Int>(<!OI;TYPE_INFERENCE_EXPECTED_TYPE_MISMATCH!><!NI;TYPE_MISMATCH!><!NI;TYPE_MISMATCH!>getMyListToReadFrom(any)<!><!><!>, int)
