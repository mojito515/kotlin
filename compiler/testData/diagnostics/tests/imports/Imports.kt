...
fun foo() {
    if (<!UNRESOLVED_REFERENCE!>i<!> <!OI;DEBUG_INFO_ELEMENT_WITH_ERROR_TYPE!><!NI;RESULT_TYPE_MISMATCH!><!NI;DEBUG_INFO_ELEMENT_WITH_ERROR_TYPE!>==<!><!><!> 3) <!UNRESOLVED_REFERENCE!>f<!>()
}
