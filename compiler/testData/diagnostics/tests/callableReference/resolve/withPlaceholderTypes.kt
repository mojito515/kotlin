...
val x4 = <!OVERLOAD_RESOLUTION_AMBIGUITY!>fn2<!>(::<!OI;OVERLOAD_RESOLUTION_AMBIGUITY!><!NI;DEBUG_INFO_MISSING_UNRESOLVED!>foo<!><!>, ::<!NI;DEBUG_INFO_MISSING_UNRESOLVED!>bar<!>)
val x5 = <!OVERLOAD_RESOLUTION_AMBIGUITY!>fn2<!>(::<!OI;OVERLOAD_RESOLUTION_AMBIGUITY!><!NI;DEBUG_INFO_MISSING_UNRESOLVED!>foo<!><!>, ::<!OI;OVERLOAD_RESOLUTION_AMBIGUITY!><!NI;DEBUG_INFO_MISSING_UNRESOLVED!>foo<!><!>)
