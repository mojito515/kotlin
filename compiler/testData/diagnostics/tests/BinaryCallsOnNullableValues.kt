...
fun f(): Unit {
    ...
    val y : Boolean? = true
    <!UNUSED_EXPRESSION!>false || <!TYPE_MISMATCH!><!NI;TYPE_MISMATCH!>y<!><!><!>
    <!UNUSED_EXPRESSION!><!TYPE_MISMATCH!><!NI;TYPE_MISMATCH!>y<!><!> && true<!>
    <!UNUSED_EXPRESSION!><!TYPE_MISMATCH!><!NI;TYPE_MISMATCH!>y<!><!> && <!CONSTANT_EXPECTED_TYPE_MISMATCH!>1<!><!>
}