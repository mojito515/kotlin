...
fun test() {
    ...
    val b: Byte = <!OI;TYPE_INFERENCE_EXPECTED_TYPE_MISMATCH!><!NI;TYPE_MISMATCH!><!NI;TYPE_MISMATCH!>id(300)<!><!><!>

    val c: Int = <!OI;TYPE_INFERENCE_EXPECTED_TYPE_MISMATCH!><!NI;TYPE_MISMATCH!><!NI;TYPE_MISMATCH!>id(9223372036854775807)<!><!><!>
    ...
    val g: Byte = <!OI;TYPE_INFERENCE_EXPECTED_TYPE_MISMATCH!><!NI;TYPE_MISMATCH!><!NI;TYPE_MISMATCH!>either(1, 300)<!><!><!>
