...
@Ann1(*<!OI;TYPE_INFERENCE_EXPECTED_TYPE_MISMATCH!><!NI;TYPE_MISMATCH!><!NI;TYPE_MISMATCH!>["a", 1, <!OI;ANNOTATION_PARAMETER_MUST_BE_CONST!>null<!>]<!><!><!>)
fun test1_2() {}
...
@Ann1(<!OI;TYPE_INFERENCE_EXPECTED_TYPE_MISMATCH!><!NI;TYPE_MISMATCH!><!TYPE_MISMATCH!>[""]<!><!><!>)
fun testVararg() {}