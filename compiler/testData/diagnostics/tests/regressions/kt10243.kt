...
private fun doUpdateRegularTasks() {
    try {
        while (f) {
            ...
            if (<!DEBUG_INFO_ELEMENT_WITH_ERROR_TYPE!>xmlText<!> <!OI;DEBUG_INFO_ELEMENT_WITH_ERROR_TYPE!><!NI;RESULT_TYPE_MISMATCH!><!NI;DEBUG_INFO_ELEMENT_WITH_ERROR_TYPE!>==<!><!><!> null) {}
            else {
