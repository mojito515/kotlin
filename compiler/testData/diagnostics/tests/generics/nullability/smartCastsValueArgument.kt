...
fun <T : CharSequence?> foo(x: T) {
    ...
    if (x != null) {
        ...
        y1 = <!OI;DEBUG_INFO_SMARTCAST!><!NI;TYPE_MISMATCH!><!NI;DEBUG_INFO_SMARTCAST!>x<!><!><!>
        y2 = <!TYPE_MISMATCH!><!NI;TYPE_MISMATCH!>x<!><!>

        <!OI;TYPE_INFERENCE_UPPER_BOUND_VIOLATED!>bar1<!>(<!NI;TYPE_MISMATCH!>x<!>)
        bar1<CharSequence>(<!OI;DEBUG_INFO_SMARTCAST!><!NI;TYPE_MISMATCH!><!NI;DEBUG_INFO_SMARTCAST!>x<!><!><!>)
        bar2(<!OI;DEBUG_INFO_SMARTCAST!><!NI;TYPE_MISMATCH!><!NI;DEBUG_INFO_SMARTCAST!>x<!><!><!>)
