...
fun illegalWhenBlock(a: Any): Int {
    when(a) {
        ...
        is String -> return <!TYPE_MISMATCH!><!NI;TYPE_MISMATCH!>a<!><!>
    }
...
fun returnFunctionLiteralExpressionBody(a: Any?): Function0<Int> =
        if (a is Int) { -> <!OI;DEBUG_INFO_SMARTCAST!><!NI;TYPE_MISMATCH!><!NI;TYPE_MISMATCH!><!NI;TYPE_MISMATCH!><!NI;TYPE_MISMATCH!>a<!><!><!><!><!> }
        else { -> 1 }
...
fun mergeSmartCasts(a: Any?) {
  ...
  if (a is String || a.<!UNRESOLVED_REFERENCE!>compareTo<!>("") <!OI;DEBUG_INFO_ELEMENT_WITH_ERROR_TYPE!><!NI;RESULT_TYPE_MISMATCH!><!NI;DEBUG_INFO_ELEMENT_WITH_ERROR_TYPE!>==<!><!><!> 0) {}
}
