...
fun test(x : Int?, a : A?) {
    ...
    x?.plus(1)
    x <!OI;UNSAFE_OPERATOR_CALL!><!NI;UNRESOLVED_REFERENCE_WRONG_RECEIVER!><!NI;DEBUG_INFO_UNRESOLVED_WITH_TARGET!>+<!><!><!> 1
    <!UNSAFE_CALL!>-<!>x
    ...
    a <!OI;UNSAFE_OPERATOR_CALL!><!NI;UNRESOLVED_REFERENCE_WRONG_RECEIVER!><!NI;DEBUG_INFO_UNRESOLVED_WITH_TARGET!>+<!><!><!> 1
    <!UNSAFE_CALL!>-<!>a
