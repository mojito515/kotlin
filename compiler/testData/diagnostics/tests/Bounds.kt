...
package boundsWithSubstitutors
    ...
    val a = B<C>()
    val a1 = B<<!UPPER_BOUND_VIOLATED!><!NI;UPPER_BOUND_VIOLATED!><!NI;UPPER_BOUND_VIOLATED!><!NI;UPPER_BOUND_VIOLATED!><!NI;UPPER_BOUND_VIOLATED!>Int<!><!><!><!><!>>()

    class X<A, B : A>()

    val b = X<Any, X<A<C>, C>>()
    val b0 = X<Any, <!UPPER_BOUND_VIOLATED!><!NI;UPPER_BOUND_VIOLATED!>Any?<!><!>>()
